            ...
            <div class="col-lg-3 col-md-4">
                ...
                <div class="bg-light p-4 mb-30">
                    <form>
                        ...
                        <a href="{{ route('user#home') }}"><label class="text-dark">All</label></a>
                ...
                <div class="row pb-3">
                            ...
                            <div class="ml-2">
                                <div class="btn-group">
                                    <select name="sorting" id="sortingOption" class="form-control">
                                        <option value="">Choose Sorting Type</option>
                    ...
                    <span class="row" id="dataList">
                        @if (count($pizza) != 0)
                            ...
                            @endforeach
                        @else
                            <p class="bg-secondary text-white text-center fs-5 col-6 offset-3 py-5">There is no pizza.</p>
                        @endif
                    </span>
