                            ...
                            <form action="{{ route('admin#update', Auth::user()->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-4 offset-1">
                                        ...
                                        <div class="mt-3">
                                            <button class="btn btn-dark text-white col-12" type="submit">Update <i class="fa-solid fa-pen-to-square"></i></button>
                                        </div>
                                    </div>
                                    <div class="col-6 mt-3">
                                        <div class="form-group">
                                            <label for="cc-payment" class="control-label mb-1">Name</label>
                                            <input id="name" name="name" value="{{ old('name', Auth::user()->name) }}" type="text"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="email" name="email" value="{{ old('email', Auth::user()->email) }}" type="email"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="phone" name="phone" value="{{ old('phone', Auth::user()->phone) }}" type="phone"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="role" name="role" value="{{ Auth::user()->role }}" type="text"
                                                class="form-control"
