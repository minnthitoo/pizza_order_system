                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="{{ route('admin#userList') }}">
                                <i class="fa fa-solid fa-users"></i>User List</a>
                        </li>
                        <li>
                            <a href="{{ route('admin#userMessage') }}">
                                <i class="fa-solid fa-message"></i>Customer Messages</a>
                        </li>
                    </ul>
                </nav>
            </div>
                                            ...
                                            <div class="account-dropdown__body">
                                                ...
                                                <div class="account-dropdown__item">
                                                    <a href="{{ route('admin#list') }}">
                                                        <i class="fa fa-solid fa-users"></i>Admin List</a>
                                                </div>
                                                <div class="account-dropdown__item">
                                            ...
                                            <div class="account-dropdown__footer my-3">
                                                <form action="{{ route('logout') }}" method="post"
                                                    ...
                                                    <button class="btn btn-dark text-white col-10" type="submit">
                                                        <i class="zmdi zmdi-power-off"></i> Logout
                                                    </button>
                                                </form>
                                            </div>
                                        </div>
